import svgPaths from "./svg-733o305slk";
...
function Content1() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-center not-italic relative shrink-0 text-[#0c0a04] text-center w-full" data-name="Content">
      <p className="font-['Inter_Display:Light',sans-serif] leading-[1.4] relative shrink-0 text-[36px] tracking-[-0.36px] w-full">Marketing that converts</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.8] relative shrink-0 text-[16px] tracking-[-0.32px] w-full">Stop guessing where your customers are. Start showing up where they actually pay attention.</p>
    </div>
  );
}
...
function Content4() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start not-italic relative shrink-0 text-[#0c0a04] w-full" data-name="Content">
      <p className="font-['Inter_Display:Light',sans-serif] leading-[1.4] relative shrink-0 text-[36px] tracking-[-0.36px] w-full">Narrative engineering that moves the needle</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.8] relative shrink-0 text-[16px] tracking-[-0.32px] w-full">{`We don't craft stories for applause. We architect narratives that convert attention into action, grounded in data and executed with relentless precision. Every word, every frame, every touchpoint is designed to drive measurable outcomes.`}</p>
    </div>
  );
}
...
function ListItem() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="List Item">
      <ul className="basis-0 block font-['Inter:Regular',sans-serif] font-normal grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#0c0a04] text-[16px] tracking-[-0.32px]">
...
function Content5() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-center not-italic relative shrink-0 text-[#0c0a04] text-center w-full" data-name="Content">
      <p className="font-['Inter_Display:Light',sans-serif] leading-[1.4] relative shrink-0 text-[36px] tracking-[-0.36px] w-full">Three weapons in our narrative arsenal</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.8] relative shrink-0 text-[16px] tracking-[-0.32px] w-full">{`We've built a system. Each tool sharpens the others. Together, they move markets.`}</p>
    </div>
  );
}
...
function Content6() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-center not-italic relative shrink-0 text-[#0c0a04] text-center w-[335px]" data-name="Content">
      <p className="font-['Inter_Tight:Regular',sans-serif] leading-[1.4] relative shrink-0 text-[24px] tracking-[0.24px] w-full">Campaigns that convert</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.8] relative shrink-0 text-[16px] tracking-[-0.32px] w-full">We map the path from awareness to action with surgical precision.</p>
    </div>
  );
}
...
function Content7() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-center not-italic relative shrink-0 text-[#0c0a04] text-center w-[335px]" data-name="Content">
      <p className="font-['Inter_Tight:Regular',sans-serif] leading-[1.4] relative shrink-0 text-[24px] tracking-[0.24px] w-full">Content systems that scale</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.8] relative shrink-0 text-[16px] tracking-[-0.32px] w-full">Narratives built to multiply, not diminish, across every channel.</p>
    </div>
  );
}
...
function Content8() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-center not-italic relative shrink-0 text-[#0c0a04] text-center w-[335px]" data-name="Content">
      <p className="font-['Inter_Tight:Regular',sans-serif] leading-[1.4] relative shrink-0 text-[24px] tracking-[0.24px] w-full">Growth analytics that prove it</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.8] relative shrink-0 text-[16px] tracking-[-0.32px] w-full">{`Numbers don't lie. We measure what matters and optimize relentlessly.`}</p>
    </div>
  );
}
...
function Content9() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-center not-italic relative shrink-0 text-[#0c0a04] text-center w-full" data-name="Content">
      <p className="font-['Inter_Display:Light',sans-serif] leading-[1.4] relative shrink-0 text-[36px] tracking-[-0.36px] w-full">Numbers that speak</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.8] relative shrink-0 text-[16px] tracking-[-0.32px] w-full">This is what deliberate narrative design looks like in practice.</p>
    </div>
  );
}
...
function Stat() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Stat">
      <p className="leading-[1.2] relative shrink-0 text-[40px] tracking-[0.4px] w-full">3x</p>
      <p className="leading-[1.4] relative shrink-0 text-[18px] tracking-[0.18px] w-full">Average engagement lift</p>
    </div>
  );
}
...
function Stat1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Stat">
      <p className="leading-[1.2] relative shrink-0 text-[40px] tracking-[0.4px] w-full">2.8x</p>
      <p className="leading-[1.4] relative shrink-0 text-[18px] tracking-[0.18px] w-full">Conversion rate improvement</p>
    </div>
  );
}
...
function Stat2() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Stat">
      <p className="leading-[1.2] relative shrink-0 text-[40px] tracking-[0.4px] w-full">47%</p>
      <p className="leading-[1.4] relative shrink-0 text-[18px] tracking-[0.18px] w-full">Audience growth sustained</p>
    </div>
  );
}
...
function Stat3() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Stat">
      <p className="leading-[1.2] relative shrink-0 text-[40px] tracking-[0.4px] w-full">68%</p>
      <p className="leading-[1.4] relative shrink-0 text-[18px] tracking-[0.18px] w-full">Increased brand recall</p>
    </div>
  );
}
...
function Stats() {
  return (
    <div className="content-stretch flex flex-col font-['Inter_Tight:Regular',sans-serif] gap-[32px] items-start not-italic overflow-clip relative shrink-0 text-[#0c0a04] w-full" data-name="Stats">
      <Stat />
      <Stat1 />
      <Stat2 />
      <Stat3 />
...
function Background() {
  return (
    <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[335px]" data-name="BACKGROUND">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 335 335">
        <g id="BACKGROUND">
          <path d={svgPaths.p1bd48300} fill="var(--fill-0, #F6EFE5)" id="Vector" />
        </g>
...
function Illustrations() {
  return (
    <div className="[grid-area:1_/_1] h-[232.476px] ml-0 mt-0 relative w-[237.685px]" data-name="ILLUSTRATIONS">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 237.685 232.476">
        <g id="ILLUSTRATIONS">
          <path d={svgPaths.pcbee872} fill="var(--fill-0, #FF8010)" id="Vector" />
          <path d={svgPaths.p1467d080} fill="var(--fill-0, #FF8010)" id="Vector_2" />
          <path d={svgPaths.p2e549a80} fill="var(--fill-0, #FF8010)" id="Vector_3" />
          <path d={svgPaths.p8144580} fill="var(--fill-0, #FF8010)" id="Vector_4" />
          <path d={svgPaths.p1622a80} fill="var(--fill-0, #FF8010)" id="Vector_5" />
          <path d={svgPaths.pf886780} fill="var(--fill-0, #FF8010)" id="Vector_6" />
          <path d={svgPaths.p3cfed400} fill="var(--fill-0, #FF8010)" id="Vector_7" />
          <path d={svgPaths.p2271d600} fill="var(--fill-0, #FF8010)" id="Vector_8" />
          <path d={svgPaths.p22f183f0} fill="var(--fill-0, #FF8010)" id="Vector_9" />
          <path d={svgPaths.p3e590a80} fill="var(--fill-0, #FF8010)" id="Vector_10" />
          <path d={svgPaths.p18a01400} fill="var(--fill-0, #FF8010)" id="Vector_11" />
          <path d={svgPaths.p10d2a380} fill="var(--fill-0, #001218)" id="Vector_12" />
          <path d={svgPaths.p39410c00} fill="var(--fill-0, #001218)" id="Vector_13" />
          <path d={svgPaths.p3a2fc6c0} fill="var(--fill-0, #001218)" id="Vector_14" />
          <path d={svgPaths.p3b4cf900} fill="var(--fill-0, #001218)" id="Vector_15" />
          <path d={svgPaths.p33f70b00} fill="var(--fill-0, #001218)" id="Vector_16" />
          <path d={svgPaths.p1d603100} fill="var(--fill-0, #001218)" id="Vector_17" />
          <path d={svgPaths.p414700} fill="var(--fill-0, #001218)" id="Vector_18" />
          <path d={svgPaths.p908fe00} fill="var(--fill-0, #001218)" id="Vector_19" />
          <path d={svgPaths.p2d65800} fill="var(--fill-0, #001218)" id="Vector_20" />
          <path d={svgPaths.p142dd080} fill="var(--fill-0, #001218)" id="Vector_21" />
          <path d={svgPaths.p109bc600} fill="var(--fill-0, #001218)" id="Vector_22" />
          <path d={svgPaths.p19e3fc00} fill="var(--fill-0, #001218)" id="Vector_23" />
          <path d={svgPaths.pef08500} fill="var(--fill-0, #001218)" id="Vector_24" />
          <path d={svgPaths.p3f5a6580} fill="var(--fill-0, #001218)" id="Vector_25" />
          <path d={svgPaths.p4f41300} fill="var(--fill-0, #001218)" id="Vector_26" />
          <path d={svgPaths.p3348a190} fill="var(--fill-0, #001218)" id="Vector_27" />
          <path d={svgPaths.p8442400} fill="var(--fill-0, #001218)" id="Vector_28" />
          <path d={svgPaths.p27e1380} fill="var(--fill-0, #001218)" id="Vector_29" />
          <path d={svgPaths.p18a2f300} fill="var(--fill-0, #001218)" id="Vector_30" />
          <path d={svgPaths.p3d91be40} fill="var(--fill-0, #001218)" id="Vector_31" />
          <path d={svgPaths.p504be00} fill="var(--fill-0, #001218)" id="Vector_32" />
          <path d={svgPaths.p43f0a00} fill="var(--fill-0, #001218)" id="Vector_33" />
          <path d={svgPaths.p214f4e00} fill="var(--fill-0, #001218)" id="Vector_34" />
          <path d={svgPaths.p13b1cf80} fill="var(--fill-0, #001218)" id="Vector_35" />
          <path d={svgPaths.p11d1b700} fill="var(--fill-0, #001218)" id="Vector_36" />
          <path d={svgPaths.p1e195880} fill="var(--fill-0, #001218)" id="Vector_37" />
          <path d={svgPaths.p2af7c00} fill="var(--fill-0, #001218)" id="Vector_38" />
          <path d={svgPaths.p1f653b00} fill="var(--fill-0, #FF8010)" id="Vector_39" />
          <path d={svgPaths.p23d93f30} fill="var(--fill-0, #001218)" id="Vector_40" />
          <path d={svgPaths.p2619fd30} fill="var(--fill-0, #001218)" id="Vector_41" />
          <path d={svgPaths.p1ce74900} fill="var(--fill-0, #001218)" id="Vector_42" />
          <path d={svgPaths.pb750000} fill="var(--fill-0, #001218)" id="Vector_43" />
          <path d={svgPaths.p3e9b4400} fill="var(--fill-0, #001218)" id="Vector_44" />
          <path d={svgPaths.p3afd00} fill="var(--fill-0, #FF8010)" id="Vector_45" />
          <path d={svgPaths.p1f869c80} fill="var(--fill-0, #001218)" id="Vector_46" />
          <path d={svgPaths.p9920a00} fill="var(--fill-0, #001218)" id="Vector_47" />
          <path d={svgPaths.p1053ff70} fill="var(--fill-0, #001218)" id="Vector_48" />
        </g>
      </svg>
    </div>
  );
...
function SectionTitle4() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start max-w-[768px] not-italic relative shrink-0 text-[#0c0a04] w-full" data-name="Section Title">
      <p className="font-['Inter_Tight:Regular',sans-serif] leading-[1.2] relative shrink-0 text-[36px] tracking-[0.36px] w-full">What they say</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.6] relative shrink-0 text-[16px] w-full">Real outcomes from real partners</p>
    </div>
  );
}
...
function Content13() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-center not-italic relative shrink-0 text-[#0c0a04] text-center w-full" data-name="Content">
      <p className="font-['Inter_Display:Light',sans-serif] leading-[1.4] relative shrink-0 text-[36px] tracking-[-0.36px] w-full">Ready to engineer growth</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.6] relative shrink-0 text-[16px] w-full">{`Let's build narratives that move markets and minds alike`}</p>
    </div>
  );
}
...
export default function Component1561MediaLabsMobile() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="1561 Media Labs • Mobile">
      {/* <Navbar /> */}
      <Header />
      <Layout />
      <Layout1 />
